...
```
Se trata de valores relativos al 2008 y comprovamos que el barrios que menos a bajado es:

__`r tail_barris$Barris[1]`__ con una diferencia de `r tail_barris$diferencia[1]`.

y el que mas ha bajado es `r head_barris$Barris[1]` con una diferencia de `r head_barris$diferencia[1]`.
